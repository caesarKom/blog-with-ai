    ...
    <>
      <div role="status" className="animate-pulse space-y-4 max-w-3xl">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 bg-gray-200 rounded-md dark:bg-gray-700 w-9/12"></div>
        </div>

        <div className="bg-gray-100 rounded dark:bg-gray-700 p-4 space-y-2">
      ...
      <div role="status" className="animate-pulse space-y-4 max-w-3xl mt-10">
        ...
        <div className="h-3 bg-gray-200 rounded-md dark:bg-gray-700 w-1/2 mt-8"></div>
