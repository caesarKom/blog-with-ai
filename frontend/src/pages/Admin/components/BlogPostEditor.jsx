...
const BlogPostEditor = ({ isEdit }) => {
  ...
  const [openBlogPostGenForm, setOpenBlogGenForm] = useState({
    open: false,
    data: null,
  })
  ...
  // Get post data by slug for edit post
  ...
  return (
    <DashboardLayout activeMenu="Blog Posts">
          ...
          <div className="form-card p-6 col-span-12 md:col-span-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  className="flex items-center gap-2.5 text-[13px] font-medium text-sky-500 bg-sky-50/60 rounded px-1.5 md:px-3 py-1 md:py-[3px] border border-sky-50 hover:border-sky-300 cursor-pointer hover:scale-[1.02] transition-all"
                  disabled={loading}
                ...
                <button
                  className="flex items-center gap-2.5 text-[13px] font-medium text-sky-600 bg-sky-50/60 rounded px-1.5 md:px-3 py-1 md:py-[3px] border border-sky-50 hover:border-sky-300 cursor-pointer hover:scale-[1.02] transition-all"
                  disabled={loading}
            ...
            <div className="form-card col-span-12 md:col-span-4 p-0">
              <div className="flex items-center justify-between px-6 pt-6">
                ...
                <button
                  ...
                  onClick={() => setOpenBlogGenForm({ open: true, data: null })}
                >
                  Generate New
                </button>
              </div>
                ...
                {ideaLoading ? (
                  ...
                  postIdeas.map((idea, index) => (
                    <BlogPostIdeaCard
                      ...
                      onSelect={() =>
                        setOpenBlogGenForm({ open: true, data: idea })
                      }
                    />
                  ))
                )}
      ...
      <Modal
        ...
        onClose={() => {
          setOpenBlogGenForm({ open: false, data: null })
        }}
        hideHeader
      >
