...
import BlogLayout from "../../../components/layouts/blockLayaut/BlogLayout"
...
const BlogPostView = () => {
  ...
  const { user, setOpenAuthForm, setOpenDeleteAlert } = useContext(UserContext)
  ...
  const handleAddReply = async () => {
    try {
      await axiosInstance.post(API_PATHS.COMMENTS.ADD(blogPostData.id), {
        content: replyText,
        parentComment: comments?.id,
      })
      toast.success("Reply added successfully!")

      setReplyText("")
      setShowReplyForm(false)
      fetchCommentByPostId(blogPostData.id)
      //
    } catch (error) {
