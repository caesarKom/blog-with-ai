...
export const generateBlogPost = async (req, res) => {
  try {
    ...
    const prompt = `Write a markdown-foematted blog post titled "${title}". Use a ${tone} tone. Include an introduction, subheadings, code examples if relevant, and a conclusion.`
...
export const generateBlogPostIdeas = async (req, res) => {
  try {
    ...
    // Clean it: Remowe ```json and ``` from beginning and end
